...
import { urlToState, stateToUrl } from './share.js'

describe(urlToState.name, () => {
    it('parses an example event-based URL v0', () => {
        const url = new URL(
    ...
    it('parses an example time-based URL v0', () => {
        const url = new URL(
    ...
    it('parses an example event-based URL from v1', () => {
        const url = new URL(
    ...
    it('parses an example time-based URL from v1', () => {
        const url = new URL(
    ...
    it('parses an example event-based URL v2', () => {
        const url = new URL(
    ...
    it('parses an example time-based URL v2', () => {
        const url = new URL(
    ...
    it('parses an example time-based URL v3', () => {
...
describe(stateToUrl.name, () => {
    it('serializes an example URL v4', () => {
        const state = {
            indicators: [
                {
                    displayName: 'Availability: Error Rate',
        ...
        const url = new URL('https://slc.alexewerlof.com/')
        // stateToUrl modifies the url in place and returns it
        const urlString = stateToUrl(url, state).toString()
        const newUrl = new URL(urlString)

        assert.equal(newUrl.searchParams.get('urlVer'), '4')
        assert.deepStrictEqual(urlToState(newUrl), {
            urlVer: 4,
            state,
        })
    })
