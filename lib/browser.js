...
/**
 * Attaches a `beforeunload` handler that prompts the user before leaving the page.
 * @param {EventTarget} [target=globalThis]
 */
...
/**
 * Detaches the `beforeunload` handler previously attached by {@link attachBeforeUnloadHandler}.
 * @param {EventTarget} [target=globalThis]
 */
