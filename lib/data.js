...
/**
 * Returns a evenly-spaced sample from dataArr of the requested size.
 * @param {number[]} dataArr source array
 * @param {number} sampleSize maximum number of elements to return
 * @returns {number[]}
 */
...
/**
 * Creates incident (bad) buckets derived from the SLI/SLO thresholds.
 * @param {number} min overall minimum data value
 * @param {number} max overall maximum data value
 * @param {{ lowerBound: string, upperBound: string }} sli
 * @param {{ lowerThreshold: number, upperThreshold: number }} slo
 * @returns {import('./buckets.js').Bucket[]}
 */
...
/**
 * Replaces a slice of originalArray with newArray, starting at insertionPoint.
 * @param {Array} originalArray
 * @param {Array} newArray
 * @param {number} insertionPoint index at which newArray is inserted
 * @returns {Array} a new array with the replacement applied
 */
