...
import { isBetween, isStr, isObj, isPIntBetween } from './validation.js'
...
export function sanitizeState(state) {
    ...
    if (isPIntBetween(state.timeSlot, config.timeSlot.min, config.timeSlot.max)) {
    ...
    if (isPIntBetween(state.windowDays, config.windowDays.min, config.windowDays.max)) {
        ret.windowDays = state.windowDays
    }

    if (isPIntBetween(state.errorBudgetValidExample, config.errorBudgetValidExample.min, config.errorBudgetValidExample.max)) {
