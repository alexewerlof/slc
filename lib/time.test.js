...
describe(humanTime.name, () => {
    it('formats duration in full form', () => {
...
describe(humanSec.name, () => {
    it('formats seconds and rounds where expected', () => {
...
describe(countTimeslices.name, () => {
    it('counts timeslices for given durations', () => {
...
describe(humanTimeSlices.name, () => {
    it('formats known timeslice labels', () => {
