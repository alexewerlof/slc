...
import { setSearchParams } from './search-params.js'
...
export function urlToState(urlStr) {
    ...
    return {
        ...
        lowerBound: url.searchParams.get('lowerBound'),
        upperBound: url.searchParams.get('upperBound'),
        lowerThreshold: num(url.searchParams.get('lowerThreshold')),
        upperThreshold: num(url.searchParams.get('upperThreshold')),
