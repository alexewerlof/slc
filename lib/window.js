...
import { countTimeslices, humanSec, humanTime } from './time.js'
import { isNum, isObj } from '../dependencies/jty.js'
 ...
 */
export class Window {
    /** @type {number} The raw number of seconds in this time window. */
    sec

    /** @type {import('../components/indicator.js').Indicator} An instance of the Indicator class. */
    indicator
    ...
    get isTimeBased() {
        return this.indicator.isTimeBased
    }
