 ...
 * @param {'eq'|'ne'|'lt'|'le'|'gt'|'ge'} htmlEntity
 ...
 * @param {'eq'|'ne'|'lt'|'le'|'gt'|'ge'} bound
 * @returns {'eq'|'ne'|'lt'|'le'|'gt'|'ge'} the opposite bound
 ...
 * @param {string} boundType the bound entity key (e.g. 'le') or empty string for no-bound
