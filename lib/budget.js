...
export class Budget extends Window {
    ...
    constructor(sec, valid, timeslice, eventCount, eventCost, currency) {
        super(sec, valid, timeslice)
    ...
    clone() {
        return new Budget(this.sec, this.valid, this.timeslice, this.eventCount, this.eventCost, this.currency)
    }
