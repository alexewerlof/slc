...
import { hasOwnProp, isObj } from '../dependencies/jty.js'
...
export function unicodeSymbol(name) {
    return hasOwnProp(unicodeSymbolMap, name) ? unicodeSymbolMap[name] : undefined
}
...
export function googleFontIcon(name) {
    return hasOwnProp(googleFontIconMap, name) ? googleFontIconMap[name] : undefined
}
