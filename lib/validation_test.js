...
test('inRangePosInt()', () => {
    assert.strictEqual(inRangePosInt(5, 1, 10), true)
    assert.strictEqual(inRangePosInt(1, 1, 10), true)
    assert.strictEqual(inRangePosInt(10, 1, 10), true)
    assert.strictEqual(inRangePosInt(0, 1, 10), false)
    assert.strictEqual(inRangePosInt(11, 1, 10), false)
    assert.strictEqual(inRangePosInt(1.5, 1, 10), false)
    assert.strictEqual(inRangePosInt(-1, 1, 10), false)
    assert.throws(() => inRangePosInt(5, '1', 10), TypeError)
    assert.throws(() => inRangePosInt(5, 1, '10'), TypeError)
    assert.throws(() => inRangePosInt(5, 10, 1), RangeError)
})
