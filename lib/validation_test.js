...
test('isBool()', () => {
    ...
    assertEquals(isBool('false'), false)
    assertEquals(isBool(''), false)
    assertEquals(isBool(undefined), false)
...
test('isUrlStr()', () => {
    assertEquals(isUrlStr('https://alexewerlof.com'), true)
    assertEquals(isUrlStr('http://alexewerlof.com'), true)
    assertEquals(isUrlStr('alexewerlof.com'), false)
    assertEquals(isUrlStr(''), false)
    assertEquals(isUrlStr(undefined), false)
    assertEquals(isUrlStr(new URL('https://alexewerlof.com')), false)
})
