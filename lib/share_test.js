...
test('An example time-based URL from v1', () => {
    ...
    assertEquals(urlToState(url), {
        ...
        state: {
            indicators: [{
                title: 'An example v1 time-based SLI',
    ...
    assertEquals(urlToState(url), {
        ...
        state: {
            indicators: [{
                ...
                lowerBound: '',
                upperBound: '',
                expectedDailyEvents: 12345678 / 30,
                eventUnit: 'all requests',
                objectives: [{
                    target: 99,
                    windowDays: 30,
...
test('An example time-based URL v3()', () => {
    const search = 'https://slc.alexewerlof.com/?urlVer=3&state=%7B%22foo%22%3A%22bar%22%7D'

    assertEquals(urlToState(search), {
        urlVer: 3,
        state: {
            foo: 'bar'
        }
