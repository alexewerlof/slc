...
export default [
    new Indicator({
        displayName: 'Availability: Prompt processing failures',
    ...
    new Indicator({
        displayName: 'Availability: Flagged responses',
    ...
    new Indicator({
        displayName: 'Availability: Response retries',
    ...
    new Indicator({
        displayName: 'Throughput: Prompt processing efficiency',
    ...
    new Indicator({
        displayName: 'Throughput: Token per second',
        description:
    ...
    new Indicator({
        displayName: 'Latency: Time to First Token',
    ...
    new Indicator({
        displayName: 'Throughput: Response token length',
        description:
    ...
    new Indicator({
        displayName: 'Latency: Time to generate complete response',
    ...
    new Indicator({
        displayName: 'Latency: Time to respond a video generation request',
    ...
    new Indicator({
        displayName: 'Latency: Time to respond an image request',
    ...
    new Indicator({
        displayName: 'Correctness: Chat length',
        description:
    ...
    new Indicator({
        displayName: 'Correctness: User feedback',
