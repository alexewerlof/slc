...
**What does it mean to "be on top of their service?"**

It means they don't rely on user report to know if there's an issue with their service because they have tied their alerting to those metrics,
